...
import 'package:brisko_billing/core/data/remote/firebase/firestore_remote_store.dart';
...
/// The smallest thing that can round-trip through the store: an id, an updatedAt,
/// and a couple of fields. It proves the store sends `toMap` up and rebuilds
/// entities with `fromRow` on the way down, without depending on a real entity's
/// schema.
...
void main() {
  ...
  FirestoreRemoteStore<_FakeEntity> storeFor(
    ...
    return FirestoreRemoteStore<_FakeEntity>(
      client: client,
  ...
  test(
    ...
    () async {
              ...
              <String, dynamic>{
                'document': <String, dynamic>{
                  'fields': <String, dynamic>{
                    'id': <String, dynamic>{'stringValue': 'cus_1'},
                    'updatedAt': <String, dynamic>{
                      'integerValue': '1750000000000',
                    },
                    'label': <String, dynamic>{'stringValue': 'Aisha'},
                  },
                },
              },
            ]),
      ...
      final FirestoreRemoteStore<_FakeEntity> store = storeFor(
        server,
        'customers',
      );
